...
public String login(String email,String password) {
	// TODO Auto-generated method stub
	return EfficenzMongoDao.getInstance().login(email, password);
...
public void sendOpenTokParametersToPatient(String patientId, String doctorId,String appointmentId) {
	
	EfficenzMongoDao.getInstance().sendOpenTokParametersToPatient(patientId, doctorId,appointmentId);
...
public String addDoctor(DoctorComplete doctorComplete) {
	// TODO Auto-generated method stub
	return EfficenzMongoDao.getInstance().addDoctor(doctorComplete);
}
